	...
	<div class="PublicBug">
		...
		<Card class="BugForm">
			<Form label-position="top" ref="formValidate" :model="formValidate" :rules="ruleValidate">
		        <Form-item label="要解决的问题网址" prop="website">
		            <Input v-model="formValidate.website" placeholder=" 以 https | http | ftp | rtsp | mms开头, 请输入要解决的问题网址，如果没有可不填"></Input>
		        </Form-item>

				<Form-item label="Bug名称" prop="bugName">
 						<Input v-model="formValidate.bugName" placeholder="请概括Bug名称"></Input>
				</Form-item>

				<Form-item label="Bug问题详情" prop="bugDesc">
					<Input v-model="formValidate.bugDesc" placeholder="请简写Bug问题" type="textarea" :autosize="{minRows: 5,maxRows: 20}"></Input>
				</Form-item>
